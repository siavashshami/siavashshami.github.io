...
<details style="border: 1px solid #ddd; border-radius: 8px; padding: 0.8rem 1.2rem; margin-bottom: 1.2rem; background: #fafafa; transition: all 0.2s;">
  ...
  <div style="padding-top: 1rem; border-top: 1px solid #eee; margin-top: 0.8rem;">
    ...
    <div style="display: flex; gap: 12px; margin: 1.2rem 0; flex-wrap: wrap;">
      ...
      <a href="images/research/open-pit-mine-01.jpg" target="_blank" style="flex: 1; min-width: 30%;">
        <img
      ...
      <a href="images/research/open-pit-mine-02.jpg" target="_blank" style="flex: 1; min-width: 30%;">
        <img
      ...
      <a href="images/research/open-pit-mine-03.jpg" target="_blank" style="flex: 1; min-width: 30%;">
        <img
