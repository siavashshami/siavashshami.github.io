...
<details style="border: 1px solid #ddd; border-radius: 8px; padding: 0.8rem 1.2rem; margin-bottom: 1.2rem; background: #fafafa; transition: all 0.2s;">
  <summary style="font-size: 1.1rem; font-weight: 600; color: #2c3e50; cursor: pointer; list-style: none; display: flex; align-items: center; gap: 8px;">
    <span style="font-size: 1.4rem;">🗂️</span> 
    4. Visualizing InSAR and Groundwater Level Changes
    <span style="margin-left: auto; font-size: 0.9rem; color: #888; font-weight: 400;">
      ⬇️ Click to expand
    </span>
  </summary>
...
<details style="border: 1px solid #ddd; border-radius: 8px; padding: 0.8rem 1.2rem; margin-bottom: 1.2rem; background: #fafafa; transition: all 0.2s;">
  ...
  <div style="padding-top: 1rem; border-top: 1px solid #eee; margin-top: 0.8rem;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin: 1rem 0; font-size: 0.95rem; background: #f0f4f8; padding: 0.8rem 1.2rem; border-radius: 6px;">
      <span><strong>📁 Format:</strong> JavaScript, Python & Shapefile</span>
    </div>
...
<details style="border: 1px solid #ddd; border-radius: 8px; padding: 0.8rem 1.2rem; margin-bottom: 1.2rem; background: #fafafa; transition: all 0.2s;">
  <summary style="font-size: 1.1rem; font-weight: 600; color: #2c3e50; cursor: pointer; list-style: none; display: flex; align-items: center; gap: 8px;">
    <span style="font-size: 1.4rem;">🗂️</span> 
    2. Shah-Gheyb Salt Dome - InSAR & ML Displacement Modeling
    <span style="margin-left: auto; font-size: 0.9rem; color: #888; font-weight: 400;">
      ⬇️ Click to expand
    </span>
  </summary>
  ...
  <div style="padding-top: 1rem; border-top: 1px solid #eee; margin-top: 0.8rem;">
    ...
    <p style="font-size: 1rem; line-height: 1.7; color: #444;">
      <strong>📌 Description:</strong><br>
     This collection of Python scripts covers the entire machine learning workflow for the Shah‑Gheyb salt dome study: from training and evaluating Random Forest and SVR models (with 100‑iteration validation), to generating spatial prediction maps from raster layers, plotting histograms and profile comparisons with error‑based coloring, comparing model performance across 29 feature scenarios.
    </p>
...
<details style="border: 1px solid #ddd; border-radius: 8px; padding: 0.8rem 1.2rem; margin-bottom: 1.2rem; background: #fafafa; transition: all 0.2s;">
  <summary style="font-size: 1.1rem; font-weight: 600; color: #2c3e50; cursor: pointer; list-style: none; display: flex; align-items: center; gap: 8px;">
    <span style="font-size: 1.4rem;">🗂️</span> 
    1. Baton Rouge, Louisiana - InSAR & ML Displacement Modeling
    <span style="margin-left: auto; font-size: 0.9rem; color: #888; font-weight: 400;">
      ⬇️ Click to expand
    </span>
  </summary>
